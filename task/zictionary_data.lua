...
local game={
    -- 网页
    {
        ...
        text="简称KoS，热门，非官块，网页，多人为主，有单机，音画廉价，电脑+手机理论可玩\n主要玩法类似下棋，每个人以7块为一个回合轮流操作，策略性很强",
    ...
    },
    {
        ...
        title="Tetr.js",
        text="简称屁块（作者网名Farter）,热门，非官块，网页，主单机，音画廉价，电脑+手机，键盘可改键触屏不行\n有一些创意模式",
        link="farter.cn/t",
    },
    {
        cat='game',
    ...
    },
    {
        ...
        title="TETR.IO",
        text="简称IO，热门，非官块，网页但建议下载，多人为主，有单机，音画优秀，电脑，会员付费，有自定义\n应该是目前全世界在线人数最多的现代块游戏\n另见#io s2",
        link="tetr.io",
    },
    {
        cat='game',
        word="js;jstris",
        title="Jstris",
        text="简称JS，热门，非官块，网页，单机联机都有，音画廉价，电脑+手机，有自定义，代码可扩展",
    ...
    },
    {
        ...
        word="tetris.com",
        title="tetris.com",
        text="Tetris官网上的块，冷门，官块，网页，主单机，音画优秀，电脑+手机，不可调控制\n只有马拉松一个模式，但有一个智能鼠标控制的玩法",
    ...
    -- 跨平台
    {
        ...
        title="Techmino",
        text="简称Tech，热门，非官块，要下载，主单机有联机，音画优秀，电脑+手机，有自定义\n大规模缝合了常见现代块内容，可练习可挑战\n目前最新版本0.17.21，可以和约好友联机对战",
        link="studio26f.org",
    },
    {
        cat='game',
    ...
    },
    {
        ...
        text="冷门，非官块，网页，单机联机都有，音画廉价，电脑+手机，不可调控制\n主要内容是经典块复刻和半实时对战",
    ...
    },
    {
        ...
        word="dtet",
        title="DTET",
        text="冷门，非官块，要下载，主单机，音画优秀，电脑，不可调控制\n基于经典规则添加了20G和强大的人体工学方块控制系统",
    },
    {
        cat='game',
    ...
    },
    {
        ...
        title="Sega Tetris",
        text="冷门，官块，要下载，主单机，音画优秀，电脑开模拟器，部分改键，不可调控制\n1999年发行的主机游戏，有1v1道具战，六种不同的消除方式能发送特殊效果",
    },
    -- 其他
    {
        cat='game',
        ...
        text="简称TEC，热门，官块，要下载，单机联机都有，音画优秀，电脑，不可调控制，正版付费\n卖点是沉浸音画体验和基于创新的Zone机制的各种模式（包括多人在线不对称竞技）",
    },
    {
        cat='game',
        word="t99;tetris 99",
        title="Tetris 99",
        text="简称T99，热门，官块，要下载，多人为主，有单机，音画优秀，主机，部分改键，不可调控制，正版付费\n主打99人混战的吃鸡模式，也有一些常用单机模式如马拉松等",
    },
    {
        cat='game',
        word="ppt;puyo puyo tetris",
        title="Puyo Puyo Tetris",
        text="简称PPT，热门，官块，要下载，多人为主，有单机，音画优秀，电脑，不可调控制，正版付费\n包含Tetris和PuyoPuyo两个下落消除游戏，二者间可以对战\n注：PPT2的手感据很多人说都不行",
    },
    {
        cat='game',
    ...
    },
    {
        ...
        word="sd;spirit drop",
        title="Spirit Drop",
        text="热门，非官块，要下载，主单机有联机，音画优秀，电脑，有自定义\n除了几个主模式外还有一个变革模式包含几十个创意规则可挑战",
