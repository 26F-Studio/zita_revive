...
local utils={
    {
        ...
        title="Zita-Revive",
        text="欢迎使用《小z词典》！\n本词典收录了大量方块游戏相关词汇和术语，萌新有疑问时发送“#关键词”即可查询\n标题前双井号表示有折叠详情，补发“##”展开\n群管急停 - %stop",
    ...
    {
        word="新人自测",
        text=CQ.img(Config.extraData.imgPath.."新人引导.png").."注：T-spin等技巧一般需要先完成上述内容，打好基础才能高效理解运用",
    },
    {
        word="t旋学习;tspin学习",
        title="关于T-Spin学习",
    ...
    {
        word="群规附录",
        text="#群规附录\n复读：重复发送他人刚发过的雷同消息\n斗图：发送大量图片或表情\n灌水：发送大量无意义的内容\n助力链接：包括各种形式，如拼多多砍一刀、抖音助力等\n无关广告：和方块无关的广告。另如有需要公告宣传，比赛或活动可以找管理，非活动的由群主和管理共同讨论\n卖弱：无上下文或不符合事实的自我贬低、过分谦虚\n误导：在他人认真提问时开误导性的玩笑\n钓鱼：以明知故问的常识问题开始话题\n伸手党：明显能自己解决的问题还来麻烦别人",
    },
    {
        word="键位",
        title="键位设置原则参考",
        text="0.具体的键位并不重要，适合自己的才是最好的\n1.不要让把两个可能需要同时按的键分给一个手指（通常只有几个旋转键不会需要同时按）\n2.不要用不灵活的手指（比如没锻炼过的小指），所有的操作频率都较高",
    ...
    {
        word="块;方块;版本",
        text="“俄罗斯方块”并不是一款具体的游戏，而是一个游戏类型，推荐在寻找游戏的时候指定游玩平台、是否接受付费、单人/多人、休闲/专业等条件\n自助查询请发送 #表格",
    },
    {
        word="赞助;打钱",
...
local main={
    ...
    {
        word="apl;效率;app",
        title="Attack per Line(Piece)",
        text="每行(块)攻击数，衡量消行-攻击的效率，例如消四打4➗4行=1效；消二打1➗2行=0.5效\n另见 #按键效率",
    },
    {
    ...
    },
    {
        word="sub",
        title="sub",
        text="英语词缀，在……之下\n常用于成绩，不说项目默认是40L，单位通常可省略，比如40行sub30(秒)，1000行sub15(分钟)",
        detail="例：39.95s是sub40，40.1s不是sub40\n不建议使用sub62之类的用法，本身就是用来大致成绩，61秒说60秒也没差\n一分钟左右的成绩精确到5~10s就可以了，30s往下再精确到1s才比较合适",
    },
    {
        word="freestyle;free",
        title="Freestyle",
    ...
    },
    {
        word="大外;大外回旋",
        title="大外回旋",
        text="指在 #SRS 环境下，Z或S块靠一个“枕头”（而不是类似T3的“屋檐”）触发(0,-2)的踢墙进入洞中的操作",
    },
    {
    ...
    {
        word="奇偶;奇偶性;斜奇偶;斜奇偶性;纵奇偶;纵奇偶性;四色奇偶;四色奇偶性;parity",
        title="(斜)奇偶性",
        text="指在堆叠过程中一些的数学不变量，可以解释如“为什么出现台阶形后很多块都放不下去”等现象。虽然实战中通常没那么多精力进行计算，但这个理论能导出一些好用的知识点，具体内容详见wiki",
        detail="还有纵奇偶、横奇偶、四色奇偶等特殊变种，在连续PC等特殊项目的理论研究中会用到",
        link="tetriswiki.cn/p/parity",
    },
    {
    ...
    },
    {
        word="s3w",
        title="Side 3 Wide",
        text="旁边空3列，比2w少见一些的连击打法，能打出的连击数比2w多，但是难度略大容易断连",
    },
    {
        word="s4w",
        title="Side 4 Wide",
    ...
    {
        word="锁定延迟;lock delay;锁延",
        title="锁定延迟",
        text="方块“碰到地面”到“锁定”之间的时间。经典块仅方块下落一格时刷新倒计时，而现代方块里往往任何操作都能重置计时器，所以一直操作就可以拖延时间。（重置次数有限，一般是15次，不允许无限拖下去）",
    },
    {
        word="生成延迟;spawn delay;are",
        title="生成延迟",
        text="“上一个方块锁定完成”到“下一个方块出现”之间的时间",
        detail="ARE名称来自“あれ”（惊讶语气词 常伴随停顿）",
    },
    {
        word="消行延迟;clear delay;line clear delay;line are",
        title="消行延迟",
        text="方块锁定并消行时，“消行动画”占据的时间",
    },
    {
        word="hypertap;hypertapping;超连点;连点",
        title="Hypertap",
    ...
    },
    {
        ...
        title="极简操作",
        text="用最少的按键数将方块移到想去的位置的技术，能提升操作效率、节约时间、减少Misdrop\n越早学习越好，由于具体的操作方法不太直观，推荐先找教程视频学会然后多加练习。刚开始快慢不重要，准确率第一，熟练后自然就快了",
    ...
    },
    {
        word="隐形;半隐;全隐",
        title="隐形",
        text="隐形指方块放置后会变得不可见的规则，一般会根据方块锁定到完全消失的具体时长区分“半隐”（锁定约几秒后才消失）和“全隐”（锁定后立刻消失，或是有很短的消失动画）",
    },
    {
        word="场地重力;重力连锁;cascade",
        title="场地重力",
    ...
    {
        word="延迟",
        text="你可能在找：#延迟块 #输入延迟 #锁定延迟 #消行延迟 #生成延迟",
    },
    {
        word="延迟块;无延迟块;无延迟",
        title="延迟/无延迟块",
        text="“延迟块”和“无延迟块”是一组没有明确定义的对立概念，大致是指刷新/消除方块时是否有无法操作的动画时间，有的话就称为“延迟块”，游戏节奏会比无延迟块慢一些",
    },
    {
...
local extra_mode={
    ...
    },
    {
        ...
        title="Tetra League",
        text="TETR.IO的全球排名对战模式，系统随机匹配实力相近的玩家，输赢会影响段位分、段位、排名\n目前是s2赛季，相比s1把堆b2b加伤换成了surge机制\n另见 #TL段位",
    },
    {
        word="段位;TL段位;TL段;D;D+;C-;C;C+;B-;B;B+;A-;A;A+;S-;S;SS;U;X;X+;D段;D+段;C-段;C段;C+段;B-段;B段;B+段;A-段;A段;A+段;S-段;S段;SS段;U段;X段;X+段",
    ...
    {
        word="段位比例;段位百分比;TL段位比例;TL段位百分比",
        title="TL段位比例",
        text="X(+): 前0.2/1%\nU/SS: 前5/11%\nS±: 前17/23/30%\nA±: 前38/46/54%\nB±: 前62/70/78%\nC±: 前84/90/95%\nD(+): 前97.5/100%",
    },
    {
    ...
    {
        word="混乱度;易挖度;messiness",
        title="[QP2机制] 混乱度&易挖度",
        text="混乱度越大，垃圾行洞位置变化概率越大；易挖度越大，垃圾行洞位置选取时越容易在好挖开的位置\n详细计算规则见 #QP2 完整文档",
    },
    {
        word="垃圾行保护",
        title="[QP2机制] 垃圾行保护",
        text="场地内的每一包含浅灰色格子的行会使`受击权重`减少0.5，至多减2.5（由于初始权重为3，所以开局会很少被打），每0.25秒刷新一次\n只在rMS rDH rAS这三个有初始场地的模式中使用",
    },
    {
        word="垃圾集中;messiness center",
        title="[QP2机制] 垃圾集中",
        text="此开关在连续洞位改变概率<=15%且在前5层内开启\n开启时，垃圾行洞位置一定不会在场地两旁的两列（10宽时就是只在中间六列）",
    },
    {
        word="多段攻击;windup",
        title="[QP2机制] 多段攻击",
        text="收到的单次攻击数值在8点及以上时，这个攻击会被特殊处理为带有预警的多段攻击，防止受击倍率后期很高时过于容易暴毙，详细规则见 #QP2 完整文档",
    },
    {
        word="受击权重;targeting factor",
        title="[QP2机制] 受击权重",
        text="玩家的“受击权重”数值会影响自身被攻击的概率，初始值为3，在3/5/7分钟时+1，详细规则见 #QP2 完整文档\n另见 #受击保护 #攻击对象",
        detail="版面闪红时会临时-1.5，部分逆位mod开启时场地里每有一行垃圾-0.5，至多-2.5",
    },
    {
        word="受击保护;targeting grace",
        title="[QP2机制] 受击保护",
        text="玩家的“受击保护”数值在受到攻击时增加和红条长度等量的数值，18封顶，该值会降低垃圾混乱度，随时间自动减少（楼层数越高和开启EX会更快），详细规则见 #QP2 完整文档\n另见 #受击权重",
    },
    {
        word="连续抵消;抵消惩罚;cancel streak;cancel sickness",
        title="[QP2机制] 连续抵消",
        text="玩家的“连续抵消”数值主要会在全程抵消垃圾行而不挖掘时增加然后触发一些特殊负面效果，防止玩家一直打循环定式抵消所有攻击，直接避开MS VL DH等mod效果，详细规则见 #QP2 完整文档",
        detail="【增加途径】抵消+N，PC+3，SZ旋时和前六次SZ里五次相同+2，双i块并排竖放场地边+3，每30s没减过+5，每75p没减过+5\n【降低途径】消垃圾清空，涨一行-3，ispin-2，消四-3，换列消四-4，换列SZ旋-2，换列JL旋-2\n【负面效果】增加受击、减少经验获取、红条激活更快、序列每包加入额外块",
    },
    {
        word="攻击对象",
        title="[QP2机制] 攻击对象",
        text="玩家无法决定自己的攻击对象，由服务器进行实时切换\n被人锁定的最终权重由服务器全权随时决定，完整算法未知，不过在游戏代码里有个debug公式：Tgt.Factor = max(0, 受击权重 + (位于榜一?2:0) - 受击保护*(受击保护+5)/50)`",
    },
    {
        word="攻击切片;切片;攻击犹豫;hesitated attack;hesitated;hesitate",
        title="[QP2机制] 攻击切片",
        text="任何玩家的单次攻击都要按4切分再发送，如10=4+4+2，多个切片打给同一个人时会重新合并，所以通常无感\n该机制应该是为了允许服务器把单次巨大攻击分配给多个玩家设计的",
        detail="如100surge切成25x4后，分配中途可以强制切换攻击目标，实现打给多个人，同时结合 #受击权重 等机制可以推测，服务器分配攻击时有理由直接根据受击保护/受击权重等值来决定切换攻击对象",
    },
    {
        word="困难模式",
        title="[QP2机制] 困难模式",
    ...
    {
        word="qp2 mod;qp mod;QP2模组;mod;模组;塔罗;塔罗牌",
        title="[QP2机制] Mod",
        text="Mod列表：专家(EX)、无暂存(NH)、混乱垃圾行(MS)、高重力(GV)、不稳定垃圾行(VL)、双洞垃圾行(DH)、隐形(IN)、All-Spin(AS)、双人(2P)\n另见 #EX/NH/...",
    },
    {
        word="EX;expert",
        title="[QP2模组] EX 专家 （皇帝 The Emperor）",
        text="启用 #困难模式\n经验流失速度增加67%，抵消和消行不再增加经验\n垃圾行瞬间出现，混乱度+，易挖度-",
    },
    {
        word="NH;nohold",
        title="[QP2模组] NH 无暂存 （节制 Temperance）",
        text="禁用暂存",
    },
    {
        word="MS;messy",
        title="[QP2模组] MS 混乱垃圾行 （命运之轮 Wheel of Fortune）",
        text="混乱度++，易挖度--",
    },
    {
        word="GV", -- gravity
    ...
    {
        word="VL;volatile",
        title="[QP2模组] VL 不稳定垃圾行 （力量 Strength）",
        text="受击倍率和抵消倍率都变为2倍（就是实际涨起的垃圾行翻倍，根据具体项目可能起正面作用）",
    },
    {
        word="DH;doublehole",
        title="[QP2模组] DH 双洞垃圾行 （恶魔 The Devil）",
    ...
    },
    {
        ...
        title="[QP2模组] rEX 逆位专家（暴君 The Tyrant）",
        text="在EX基础上，\n击杀奖励从15m降到8m，受击保护释放更快\n不再随时间自动爬升而是下坠，在一层停留60s后受击倍率+0.5%/s\n疲劳事件更早更严苛",
    },
    {
        word="rNH;asceticism",
        title="[QP2模组] rNH 逆位无暂存（禁欲 Asceticism）",
        text="启用 #困难模式\n禁用暂存，纯随机序列，1预览，没有影子\nSpin全部计为Mini（基础攻击=消行数-1）\n垃圾行都变成2宽的样式",
    },
    {
        word="rMS;loaded dice",
        title="[QP2模组] rMS 逆位混乱（铅骰 Loaded Dice）",
        text="启用 #困难模式\n垃圾混乱度增加，消行延迟从0增加为1.15秒\n初始场地为六个圈的图案，启用 #垃圾行保护",
    },
    {
        word="rGV;freefall",
        title="[QP2模组] rGV 逆位高重力（自由落体 Freefall）",
        text="启用 #困难模式\n一开局就立刻加速进入20G\n每层的锁定延迟：24 22 20 18 16 15 14 13 12 11 （帧）",
    },
    {
        word="rVL;last stand",
        title="[QP2模组] rVL 逆位双倍（顽抗 Last Stand）",
        text="启用 #困难模式\n受击倍率变为3倍\n14高场地，增加两个垃圾行洞位置预告\n垃圾易挖度锁定在一个很高的值，永远开启 #垃圾集中",
    },
    {
        word="rDH;damnation",
        title="[QP2模组] rDH 逆位双洞（天谴 Damnation）",
        text="启用 #困难模式\n非T块不再判Spin，禁用攻击，需要挖垃圾行临时启用\n垃圾行为每行随机3~4个灰格，固定4行垃圾少了立刻出\n初始场地为12行棋盘垃圾行，启用 #垃圾行保护",
    },
    {
        word="rIN;the exile;exile",
        title="[QP2模组] rIN 逆位隐形（流亡者 The Exile）",
        text="启用 #困难模式\n自己放置的方块会隐形，垃圾行只能看到最浅层的三行，开局会收系统3行垃圾",
    },
    {
        word="rAS;the warlock;warlock",
        title="[QP2模组] rAS 逆位全旋（邪术师 The Warlock）",
    ...
    },
    {
        ...
        title="[QP2模组] rPN 逆位五连（愚蠢的徒劳 A Fool's Errand）",
