...
local main={
    ...
    {
        word="63;63堆;63堆叠;6–3堆叠;36堆叠;36堆",
        title="6–3堆叠法",
        text="指左边6列右边3列的堆叠方式。在玩家有足够的计算能力后可以减少堆叠所用的按键数（反之可能甚至会增加），是主流的用于减少操作数的高端40L堆叠方式，原理跟出块位置是中间偏左有关。\n3-6堆叠是其镜像，与6-3堆叠一样非常适合构造火力，但不利于40L",
    },
	{
		word="27堆叠;27堆;72堆叠;72堆",
		title="2-7堆叠法",
		text="左边两列右边七列的堆叠方式。最常见的2-7堆叠是用来打20TSD的LST。\n7-2堆叠法是其镜像",
	},
	{
		word="18堆叠;1-8 stacking;81堆叠",
		title="1-8堆叠法",
        text="在最左丢 I，空出第二列，而在右边八列堆叠的玩法。在对战中，这是所有空一列(1w)堆叠策略中最难维持 B2B 的一种。\n8-1堆叠是其镜像。\nTETR.IO有一项挑战性成就，就是使用1-8或8-1堆叠进行10次消四，完成40行。",
	},
	{
		word="45堆叠;54堆叠;45堆;54堆",
		title="4-5堆叠法",
		text="左边四列右边五列的堆叠方式，#c1w 的一种。\n5-4堆叠是其镜像",
	},
    {
