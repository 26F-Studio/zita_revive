return {
    ...
    {1,2,2,2,0,2,2,2,2,2,2,2,0,"gems;tetris gems","Tetris Gems","tetris.com/play-tetrisgems","限时1分钟挖掘，有Cascade，有三种消除后可以获得不同功能的宝石方块"},
    {1,2,2,2,0,2,2,2,0,2,2,0,1,"C::Reactris;c4r;c::r;Reactris","C::Reactris","b23.tv/BV13u411G75m","在方块里加入了丰富的Minecraft元素，有大量创意玩法"},
    {1,2,2,2,0,2,2,2,0,2,2,0,0,"aqm;aquamino","Aquamino","aqua6623.itch.io/aquamino","除了基础的单机模式外还有冰风暴、多线程、激光、雷暴等创意模式"},
    {1,2,2,2,0,2,2,1,0,1,0,2,0,"tgm3;ti","TGM3 （Terror Instinct）","","TGM3引入了更多现代化规则，终于有了暂存功能（可预输入），增加了C/W操作模式选择（W规使用SRS）\n模式有：Easy（200分）、Sakura（地图挖掘）、Master（段位考试）、Shirase（2代death升级版）\n另见 #tgm #tgm1~4"},
    {1,2,2,2,0,2,2,0,0,2,2,0,1,"chextris","Chextris","chemicalex.itch.io/chextris","在方块里加入了音游元素，也有40L等基础模式"},
    ...
    {1,2,2,2,0,2,2,0,0,2,2,0,0,"tetra chroma;chroma","Tetra Chroma","store.steampowered.com/app/2702490","俄罗斯方块创意改版，一行颜色相同才能消"},
    {1,2,2,2,0,2,2,0,0,2,2,0,0,"poly;polyform","Polyform","stellartophat.itch.io/polyform","有三角形和六边形的单元格"},
    {1,2,2,1,2,2,2,0,0,2,0,0,0,"tetra esports;tes","Tetra eSports","tetraesports.com/","Tetra Online转生，目前还在开发阶段"},
    ...
    {1,2,2,1,0,2,2,0,2,2,2,0,0,"tetra legends","Tetra Legends","tetralegends.app","有两个隐藏的节奏模式，并且将一些其他游戏中不可见的机制进行了可视化，动效也很多。于2020年12月基本确定由于各种原因不再继续开发"},
    ...
    {1,2,2,1,0,2,2,0,0,2,0,0,0,"hebo;heboris","Heboris","","仿街机方块游戏，可以模拟多个方块游戏的部分模式"},
    {1,2,2,1,0,2,2,0,0,2,0,0,0,"example block game;ebg","Example Block Game","github.com/Oshisaure/example-block-game","仿TGM的街机方块游戏，有一个不区分szi正反朝向的旋转系统"},
    {1,2,2,1,0,2,1,1,0,1,0,2,0,"tetris giant;giant;dekaris","Tetris Giant (Dekaris)","","街机游戏，6*7的场地，有限时打分模式和一个比行数的生存模式"},
    {1,2,2,1,0,2,1,0,0,1,0,2,0,"sega;sega tetris","Sega Tetris","","1999年发行的主机游戏，有1v1道具战，六种不同的消除方式能发送特殊效果"},
    {1,2,2,0,2,2,2,2,0,0,2,0,1,"testmino","Testmino","","微信小程序方块，搜索“联机俄罗斯方块”即可，模式有40L、挖40L、限时打分、好友对战、匹配单挑"},
    {1,2,2,0,2,2,2,2,0,0,2,0,0,"jj;jj块","JJ tetris","","JJ棋牌平台下的“JJ比赛”app内的休闲游戏（看不到可能是因为限制了新玩家不可见）","是现代方块但：竖屏，可自定义ASD/ASP，能自定义键位，无Hold，无B2B，无攻击缓冲不可抵消，每次攻击上限为4，连击较强"},
    {1,2,2,0,2,2,2,2,0,0,2,0,0,"引力星球;引力","引力星球","","引力星球app内的休闲游戏"},
    {1,2,2,0,2,2,2,2,0,0,2,0,0,"决战方块;决战","决战方块","","taptap平台的方块，搜索“决战方块”即可，模式有马拉松、40L、生存、匹配单挑"},
    ...
    {1,1,2,2,0,2,2,1,2,2,2,0,0,"屁块;tetrjs;tetr.js","Tetr.js","farter.cn/t","tetr.js的一个衍生版本，有较多创意模式，触屏只能选预设布局不能自定义"},
    {1,1,2,2,0,2,2,0,2,2,2,0,1,"asc;ascension","Ascension","asc.winternebs.com","有一些创意模式，ASC旋转系统就来自这里"},
    ...
    {1,1,2,1,0,2,2,0,0,2,2,0,2,"tetro tui","Tetro TUI","github.com/Strophox/tetro-tui","控制台方块，有完善的现代参数设置，甚至做了各种特效"},
    ...
    {1,1,2,0,1,2,2,0,2,2,0,0,0,"nuke;nuketris","Nuketris","nuketris.com","有几个基础单机模式和1V1排位"},
    ...
    {0,2,2,1,0,2,2,1,0,1,0,2,0,"tgm2;ta","TGM2 （The Absolute）","","TGM2引入了新模式：Normal（300分）、Master（999分段位模式，有隐形字幕战）、T.A.Death（全程20G）、Doubles（双人合作14列场地300分）\n另见 #tgm #tgm1~4"},
    {0,2,2,1,0,2,2,1,0,1,0,2,0,"tgm1","TGM1","","TGM1作为系列第一作就确定了系列很多基础设定，如20G，level得分系统、ARS旋转系统、预输入旋转\n主模式只有一个，类马拉松但后期是20G，目标是尽可能多消四获得分数，在限定时间内达到特定lv，最终获得GM段位\n另见 #tgm #tgm1~4"},
