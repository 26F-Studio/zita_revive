return {
    ...
    {2,2,2,1,2,2,2,0,2,2,2,0,1,"io;tetrio;tetr.io","TETR.IO","tetr.io","应该是目前全世界在线人数最多的现代块游戏\n另见#io qp2"},
    ...
    {1,2,2,1,0,2,2,0,0,2,0,0,0,"example block game;ebg","Example Block Game","github.com/Oshisaure/example-block-game","一个仿TGM的街机方块游戏，有一个不区分szi正反朝向的旋转系统"},
    {1,2,2,1,0,2,1,0,0,1,0,2,0,"sega;sega tetris","Sega Tetris","","1999年发行的主机游戏，有1v1道具战，六种不同的消除方式能发送特殊效果"},
    {1,2,2,0,2,2,2,2,0,0,2,0,0,"jj;jj块","JJ tetris","","JJ棋牌平台下的“JJ比赛”app内的一个休闲游戏（看不到可能是因为限制了新玩家不可见）","是现代方块但：竖屏，可自定义ASD/ASP，能自定义键位，无Hold，无B2B，无攻击缓冲不可抵消，每次攻击上限为4，连击较强"},
    {1,2,2,0,2,2,2,2,0,0,2,0,0,"引力星球;引力","引力星球","","引力星球app内的一个休闲游戏"},
    ...
    {1,1,2,2,0,2,2,0,2,2,2,0,0,"asc;ascension","Ascension","asc.winternebs.com","有一些创意模式，ASC旋转系统就来自这里"},
